  ...
  <body>
    <div class="invoice-box" style="background-color: white; margin-bottom:40px; margin-top: 40px;">
      ...
      background-color: #dddddd;
        ...
        <h2 style="margin-top:50px;">Project Accuracy Report</h2>
      <table class="table">
        <tr class="tr">
          <th class="th">Name</th>
        ...
        <tr class="tr">
          <td class="td">Anang Panday</td>
          <td class="td">+9876786555</td>
          <td class="td">Content Writing</td>
          <td class="td">Target</td>
          <td class="td">2021-11-17</td>
          <td class="td">2021-11-19</td>
          <td class="td">50%</td>
        </tr>
      </table>
      <br>
