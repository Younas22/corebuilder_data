...
$('select[name="autotyper_user_project"]').change(function() {
let autotyper_user_project = $(this).val();
let earning_details = $('#earning_details').html('');
$.ajax({
url: "<?php echo base_url("admin/get_autotyper_user_project");?>",
type: "POST",
data: {
autotyper_user_project: autotyper_user_project
},
dataType:"json",
cache: false,
success: function(dataResult){
    // alert(dataResult.res._right);
let html = '<div class="row"><div class="col-lg-3"><div class="form-group" style="margin-bottom: 30px;"><label>Right</label><p>'+dataResult.res._right+'</p></div><div class="form-group"><label>Right Edit</label><input type="text" name="right" class="form-control" placeholder="Right Edit" value="'+dataResult.res._right+'"></div></div><div class="col-lg-3"><div class="form-group" style="margin-bottom: 30px;"><label>Wrong</label><p>'+dataResult.res.wrong+'</p></div><div class="form-group"><label>Wrong Edit</label><input type="text" name="wrong" class="form-control" placeholder="Wrong Edit" value="'+dataResult.res._right+'"></div></div><div class="col-lg-3"><div class="form-group" style="margin-bottom: 30px;"><label>Complete</label><p>'+dataResult.res.complete_work+'</p></div><div class="form-group"><label>Complete Edit</label><input type="text" name="complete" class="form-control" placeholder="Complete Edit" value="'+dataResult.res.complete_work+'"></div></div><div class="col-lg-3"><div class="form-group" style="margin-bottom: 30px;"><label>Earning</label><p>'+dataResult.res.earning+'</p></div><div class="form-group"><label>Earning Edit</label><input type="text" name="earning" class="form-control" placeholder="Earning Edit" value="'+dataResult.res.earning+'"></div></div></div>';

earning_details.html(html);
